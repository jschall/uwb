...
MODULES_ENABLED = chibios_sys_init chibios_hal_init pubsub param uavcan flash dw1000 spi_device timing app_descriptor boot_msg can can_auto_init worker_thread lpwork_thread uavcan_param_interface uavcan_debug uavcan_allocatee uavcan_restart system uavcan_nodestatus_publisher uavcan_getnodeinfo_server uavcan_beginfirmwareupdate_server
