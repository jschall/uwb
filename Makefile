...
MODULES_ENABLED = chibios_sys_init chibios_hal_init can can_autobaud can_driver_stm32 pubsub param uavcan flash driver_dw1000 spi_device ext_irq timing app_descriptor boot_msg worker_thread uavcan_param_interface uavcan_debug uavcan_allocatee uavcan_restart system uavcan_nodestatus_publisher uavcan_getnodeinfo_server uavcan_beginfirmwareupdate_server
